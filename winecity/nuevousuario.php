<?php
	...
	{
		$nombre = $_REQUEST['nombrenuevo'];
		$email = $_REQUEST['emailnuevo'];
		$clave = $_REQUEST['clavenueva'];
		...
		}else
		{
			...
			{
				$_SESSION['active'] =0;
				mail('alemarchena@gmail.com', 'Nuevo usuario:' . $nombre, $nombre . ' se agrego a la plataforma,' . 'con el usuario:' . $email);
			    header("Location: bienvenido.php");
				exit();
			}else
			{
				$respuesta = "Algo no funciono con la creacion";
			}
			exit();	
		}
	}
...
<body>
	...
	<div class="offset-sm-4 col-sm-4 offset-md-4 col-md-4 offset-lg-4 col-lg-4" align="center">
		<form class="form-signin" action="" method="post">
			...
			<button class="btn btn-lg btn-primary btn-block" id="guardar" name="guardar" action="" type="submit"> Guardar</button>
    	</form>

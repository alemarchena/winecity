...
<div class="border border-success">
    <h2 class="mensajeservidor" align="center">HOTELES</h2>
                                                        <!--  ACORDEON -->
            ...
            <div class="card-header" id="headingOne">
              <h5 class="mb-0">
                ...
                <button class="btn btn-info btn-block" type="button" data-toggle="collapse" data-target="#collapseOneS" aria-expanded="true" aria-controls="collapseOneS">
                  <p class="mensajeservidor" align="center">Alta de Hoteles</p>
                </button>
              </h5>
            </div>
                    ...
                    <div class="row">
                        <div class="offset-md-4 col-md-4">
                            <form class="form-signin" action="">
                                <button type="button"  class="btn btn-md btn-primary btn-block" id="guardarhotel" name="guardar"> Guardar</button>
                            </form>
                        </div>
                        <div class="col-md-2">
                            <form class="form-signin" action="">
                                <button type="button"  class="btn btn-md btn-info btn-block" id="nuevohotel" name="nuevo"> Nuevo</button>
                            </form>
                        </div>
                    </div>
                    <br>
        ...
        <div class="card-header" id="headingTwo">
          <h5 class="mb-0">
            <button class="btn btn-info btn-block" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                <p class="mensajeservidor text-danger">Lista de hoteles</p>
            </button>
          </h5>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="offset-md-3 col-md-1">
                        <input type="text" id="idhotel" name="idhotel" placeholder="Id" class="form-control"  value="<?php  if(isset($idservicio)) echo $idhotel ?>" >
                    </div>
                    <div class="col-md-4">
                        <form class="form-signin" action="">
                            <button type="button"  class="btn btn-md btn-info btn-block" id="consultahoteles_abm"> Ver</button>
                        </form>
                    </div>
                </div>
                <div class="table-responsive-md">
                    <table id="tabla_hoteles" class="table w-auto table-bordered table-striped">
                        <thead>
                            <tr class="btn-info">
                                <th scope="col"></th>
                                <th scope="col"></th> 

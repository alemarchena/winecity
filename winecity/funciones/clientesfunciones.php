...

                {
                    ...
                    $.each(datadecodificado,function(key,value)
                    {
                        ...
                        {//agrego botones SI 
                            ...
                            var fila = "<tr><td><span style='font-size: 20px; color: Dodgerblue;'><i class='fas fa-check-circle'></i></span><input type='button' value = '' class = 'btn btn-sm btn-info' onclick='seleccionarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\")'/></td><td>"+datadecodificado[key].id_cliente+"</td><td>"+datadecodificado[key].emailcliente+"</td></tr>";
                        ...
                        { //agrego botones BORRAR y EDITAR
                            ...
                            var fila = "<tr><td><input type='button' value = 'X' class = 'btn btn-sm btn-danger' onclick='eliminarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\"><td><input type='button' value = 'Editar' class = 'btn btn-sm btn-info' onclick='editarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\")'/></td> <td>"+datadecodificado[key].id_cliente+"</td><td>"+datadecodificado[key].emailcliente+"</td></tr>";
                        }else 
                        if(tipo==="cabm")

                        { //agrego botones CONSULTAR, EDITAR Y BORRAR

                            var fila = "<tr> <td><span style='font-size: 20px; color: Dodgerblue;'><i class='fas fa-check-circle'></i></span><input type='button' value = '' class = 'btn btn-sm btn-info' onclick='seleccionarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\")'/></td><td><input type='button' value = 'Editar' class = 'btn btn-sm btn-info' onclick='editarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\")'/></td> <td><input type='button' value = 'X' class = 'btn btn-sm btn-danger' onclick='eliminarcliente(\"" +datadecodificado[key].id_cliente+ "\",\"" +datadecodificado[key].emailcliente+ "\")'></td> <td>"+datadecodificado[key].id_cliente+"</td><td>"+datadecodificado[key].emailcliente+"</td></tr>";
                        }

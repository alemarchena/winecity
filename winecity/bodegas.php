...
<div class="row">
    <div class="offset-md-4 col-md-4">
        <form class="form-signin" action="">
        	<button type="button"  class="btn btn-md btn-info btn-block" id="guardar" name="guardar"> Guardar</button>
        </form>
    </div>
    <div class="col-md-2">
        <form class="form-signin" action="">
...
<br>
<div style="border-top: 2px solid #D5DCE5;padding: 20px 0;"></div>
                                                <!-- ID - BOTON Y LISTA-->
...
<div class="border border-success">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form class="form-signin" action="">
                <button style="background-color: #5cb98f" type="button"  class="btn btn-md btn-block" id="consultabodegas"> Consultar</button>
            </form>
        </div>
    </div>
